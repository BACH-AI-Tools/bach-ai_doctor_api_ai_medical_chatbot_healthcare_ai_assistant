...
# OpenAPI 规范
OPENAPI_SPEC = """{\n  \"openapi\": \"3.0.0\",\n  \"info\": {\n    \"title\": \"Ai Doctor Api Ai Medical Chatbot Healthcare Ai Assistant\",\n    \"version\": \"1.0.0\",\n    \"description\": \"RapidAPI: bilgisamapi-api2/ai-doctor-api-ai-medical-chatbot-healthcare-ai-assistant\"\n  },\n  \"servers\": [\n    {\n      \"url\": \"https://ai-doctor-api-ai-medical-chatbot-healthcare-ai-assistant.p.rapidapi.com\"\n    }\n  ],\n  \"paths\": {\n    \"/chat\": {\n      \"post\": {\n        \"summary\": \"Neurosurgery\",\n        \"description\": \"Neurosurgery\",\n        \"operationId\": \"neurosurgery\",\n        \"parameters\": [\n          {\n            \"name\": \"noqueue\",\n            \"in\": \"query\",\n            \"required\": false,\n            \"description\": \"Example value: 1\",\n            \"schema\": {\n              \"type\": \"string\",\n              \"default\": null,\n              \"enum\": null\n            }\n          }\n        ],\n        \"responses\": {\n          \"200\": {\n            \"description\": \"Successful response\",\n            \"content\": {\n              \"application/json\": {\n                \"schema\": {}\n              }\n            }\n          }\n        }\n      }\n    }\n  },\n  \"components\": {\n    \"securitySchemes\": {\n      \"ApiAuth\": {\n        \"type\": \"apiKey\",\n        \"in\": \"header\",\n        \"name\": \"X-RapidAPI-Key\"\n      }\n    }\n  },\n  \"security\": [\n    {\n      \"ApiAuth\": []\n    }\n  ]\n}"""
...
if API_KEY:
    ...
    default_headers["X-RapidAPI-Host"] = "ai-doctor-api-ai-medical-chatbot-healthcare-ai-assistant.p.rapidapi.com"
else:
...
client = httpx.AsyncClient(
    base_url="https://ai-doctor-api-ai-medical-chatbot-healthcare-ai-assistant.p.rapidapi.com", 
    timeout=30.0
)
...
mcp = FastMCP.from_openapi(
    ...
    client=client,
    name="ai_doctor_api_ai_medical_chatbot_healthcare_ai_assistant",
    version=__version__
)
...
async def _add_rapidapi_headers(method, url, **kwargs):
    ...
    if API_KEY:
        ...
        kwargs['headers']['X-RapidAPI-Host'] = "ai-doctor-api-ai-medical-chatbot-healthcare-ai-assistant.p.rapidapi.com"
    else:
...
def main():
    """主入口点"""
    print(f"🚀 启动 Ai Doctor Api Ai Medical Chatbot Healthcare Ai Assistant MCP 服务器")
    print(f"📦 版本: {__tag__}")
